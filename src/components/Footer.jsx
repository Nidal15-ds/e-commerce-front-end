    ...
    <footer className="footer">
      <div className="footer-content">
        <div className="footer-section">
          <h3>DZ Store</h3>
          <p>Your premier destination for traditional Qamiss, modern streetwear, sport shoes, and exclusive bundles across all 58 wilayas in Algeria.</p>
        </div>
      ...
      <div className="footer-bottom">
        <p>&copy; {new Date().getFullYear()} DZ Store. All rights reserved.</p>
      </div>
    </footer>
  );
}